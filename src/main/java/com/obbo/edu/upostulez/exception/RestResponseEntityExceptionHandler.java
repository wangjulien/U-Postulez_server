...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	// public ResponseEntity<Object> handleMail(final RuntimeException ex, final
	// WebRequest request) {
	// logger.error("500 Status Code", ex);
	// final GenericResponse bodyOfResponse = new
	// GenericResponse(messages.getMessage("message.email.config.error", null,
	...
	// public ResponseEntity<Object> handleReCaptchaUnavailable(final
	// RuntimeException ex, final WebRequest request) {
	// logger.error("500 Status Code", ex);
	// final GenericResponse bodyOfResponse = new
	// GenericResponse(messages.getMessage("message.unavailableReCaptcha", null,
