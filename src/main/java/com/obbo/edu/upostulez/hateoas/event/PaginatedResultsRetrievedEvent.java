...
/**
 * Event that is fired when a paginated search is performed. This event object
 * contains all the information needed to create the URL for the paginated
 * results
 * 
 * @param <T>
...
public final class PaginatedResultsRetrievedEvent<T extends Serializable> extends ApplicationEvent {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 166800738147658919L;
